...
class GAME:
    def play(self):
        ...
        while (games_to_play<=0):
            try:
                games_to_play=int(input("Enter the number of games you want to play :"))
            except:
        ...
        while (game_number<games_to_play):
            ...
            if self.check_winner(player_hand,dealer_hand):
                continue
            print("Final Results")
            print("Your hoand :",player_hand_value)
    ...
    def check_winner(self,player_hand,dealer_hand,game_over=False):
        if not game_over:
            if player_hand.get_value()>21:
                ...
                print("Both of the players have blackjack , its tie !!")
                return True
            elif player_hand.is_blackjack():
                print("You have the blackjack you win !")
                return True
            elif dealer_hand.get_value()>21:
                print("Daler has the blackjackk, dealer wins !")
                return True
        else:
